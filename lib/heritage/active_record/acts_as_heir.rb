  ...
  module ActiveRecord
    module ActsAsHeir
      ...
      def acts_as_heir_of(predecessor_symbol)
        ...
        self._predecessor_klass = Object.const_get(predecessor_symbol.to_s.capitalize.singularize.camelize)

        has_one :predecessor, :as => :heir, :class_name => predecessor_symbol.to_s.capitalize.singularize.camelize, :autosave => true, :dependent => :destroy
